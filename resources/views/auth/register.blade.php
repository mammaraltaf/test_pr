            ...
            <div class="w-lg-600px p-10 p-lg-15 mx-auto">
                ...
                <!--begin::Heading-->
                    ...
                    <div class="row fv-row mb-7">
                        ...
                        <label class="form-label fw-bolder text-dark fs-6">Name<span style="color:red">*</span></label>
                    ...
                    <div class="fv-row mb-7">
                        <label class="form-label fw-bolder text-dark fs-6">Country<span style="color:red">*</span></label>
                        <select name="country" aria-label="Select a Country" data-control="select2" data-placeholder="Select a country..." required class="form-select form-select-solid form-select-lg fw-bold">
                    ...
                    <div class="fv-row mb-7">
                        <label class="form-label fw-bolder text-dark fs-6">Timezone<span style="color:red">*</span></label>
                        <select name="timezone" aria-label="Select a Timezone" data-control="select2" data-placeholder="Select a timezone.." class="form-select form-select-solid form-select-lg" required >
